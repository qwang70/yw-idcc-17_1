...
# @in fn_L1  @as FN_Detector @desc LIGO GW150914 data at sampling rate 4096 Hz @uri file:{Detector}_LOSC_4_V1-1126259446-32.hdf5
...
# @in fn_L1  @as FN_Detector @uri file:{Detector}_LOSC_4_V1-1126259446-32.hdf5
# @in fn_sr @as FN_Sampling_rate @uri file:H-H1_LOSC_{downsampling}_V1-1126259446-32.hdf5
...
plt.savefig(output_folder+'GW150914_strain.png')
