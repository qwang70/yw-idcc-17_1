...
output_folder = curr_path+'/../output/'
# First from H1
fn_H1 = 'H-H1_LOSC_4_V1-1126259446-32.hdf5'
strain_H1, time_H1, chan_dict_H1 = rl.loaddata(input_folder+fn_H1, 'H1')
# and then from L1
fn_L1 = 'L-L1_LOSC_4_V1-1126259446-32.hdf5'
strain_L1, time_L1, chan_dict_L1 = rl.loaddata(input_folder+fn_L1, 'L1')
# read in the data at 16384 Hz and at 4096 Hz:
fn_16 = 'H-H1_LOSC_16_V1-1126259446-32.hdf5'
strain_16, time_16, chan_dict = rl.loaddata(input_folder+fn_16, 'H1')
fn_4 = 'H-H1_LOSC_4_V1-1126259446-32.hdf5'
strain_4, time_4, chan_dict = rl.loaddata(input_folder+fn_4, 'H1')
...
NRtime, NR_H1 = np.genfromtxt(input_folder+'GW150914_4_NR_waveform.txt').transpose()
...
plt.title('Advanced LIGO strain data near GW150914')
plt.savefig(output_folder+'GW150914_ASDs.png')
...
plt.savefig(output_folder+'GW150914_strain_whitened.png')
...
plt.savefig(output_folder+'GW150914_H1_spectrogram.png')
...
plt.savefig(output_folder+'GW150914_L1_spectrogram.png')
...
plt.title('aLIGO H1 strain data near GW150914')
plt.savefig(output_folder+'GW150914_H1_spectrogram_whitened.png')
...
plt.axis([-0.5, 0.5, 0, 500])
plt.title('aLIGO L1 strain data near GW150914')
plt.savefig(output_folder+'GW150914_L1_spectrogram_whitened.png')
...
plt.savefig(output_folder+'GW150914_filter.png')
...
plt.savefig(output_folder+'GW150914_H1_strain_unfiltered.png')
...
plt.savefig(output_folder+'GW150914_H1_strain_filtered.png')
...
# write the files:
write_wavfile(output_folder+"GW150914_H1_whitenbp.wav",int(fs), strain_H1_whitenbp[indxt])
write_wavfile(output_folder+"GW150914_L1_whitenbp.wav",int(fs), strain_L1_whitenbp[indxt])
write_wavfile(output_folder+"GW150914_NR_whitenbp.wav",int(fs), NR_H1_whitenbp)
...
# write the files:
write_wavfile(output_folder+"GW150914_H1_shifted.wav",int(fs), strain_H1_shifted[indxt])
write_wavfile(output_folder+"GW150914_L1_shifted.wav",int(fs), strain_L1_shifted[indxt])
write_wavfile(output_folder+"GW150914_NR_shifted.wav",int(fs), NR_H1_shifted)
...
plt.legend(loc='upper center')
plt.title('Advanced LIGO strain data near GW150914')
plt.savefig(output_folder+'GW150914_H1_ASD_16384.png')
...
plt.legend(loc='upper center')
plt.title('Advanced LIGO strain data near GW150914')
plt.savefig(output_folder+'GW150914_H1_ASD_16384_zoom.png')
...
plt.title('Advanced LIGO strain data near GW150914')
plt.savefig(output_folder+'GW150914_H1_ASD_4096_zoom.png')
...
strain, time, chan_dict = rl.loaddata(input_folder+fn, 'H1')
