...
# draw recon worfklow graph upstream of strain_L1_whitenbp
$QUERIES_DIR/render_wf_recon_graph_upstream_of_data_q5.sh strain_L1_whitenbp > $RESULTS_DIR/wf_recon_upstream_of_strain_L1_whitenbp.gv
dot -Tpdf $RESULTS_DIR/wf_recon_upstream_of_strain_L1_whitenbp.gv > $RESULTS_DIR/wf_recon_upstream_of_strain_L1_whitenbp.pdf
dot -Tsvg $RESULTS_DIR/wf_recon_upstream_of_strain_L1_whitenbp.gv > $RESULTS_DIR/wf_recon_upstream_of_strain_L1_whitenbp.svg
